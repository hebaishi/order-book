...
// configuration step. It creates a namespace called `order_book`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", order_book::cmake::project_name, order_book::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", order_book::cmake::project_version);
      return EXIT_SUCCESS;
    }
